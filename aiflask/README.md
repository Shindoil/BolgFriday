# 한국어 채팅 대화 내용에서의 상품명 인식 및 추출을 위한 자연어 처리 모델 개발 (로지스틱 회귀 모델)
...
&nbsp;한국어 채팅 대화 내용에서의 상품명 인식 및 추출을 위한 자연어 처리 모델 개발은 약 한 달간 개인적으로 수행되었으며, 데이터 수집부터 전처리, 모델 설계 및 학습, 평가에 이르기까지 전 과정을 독자적으로 진행하였다. <br/>
...
&nbsp;한국어 채팅 대화 내용에서의 상품명 인식 및 추출을 위한 자연어 처리 모델 개발 연구를 통해 비정형 텍스트 데이터에서 원하는 정보를 추출하는 자연어 처리 기술의 가능성을 확인할 수 있었다. 앞으로도 활발한 연구를 통해 자연어 처리 분야의 발전에 기여할 수 있기를 기대한다.
